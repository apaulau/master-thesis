...
\newpage
\chapter{Вспомогательные определения}
\label{c:definitions}
...
\begin{Definition}
\label{def:corr_cov}
	\textit{Нормированной корреляционной функцией} называется функция вида
	\begin{equation*}
...
\begin{Definition}
	...
	\begin{enumerate}
		...
		\item $ R(t_1, t_2) = R(t_1 - t_2), t_1,t_2 \in \mathbb{T} $.
	\end{enumerate}
\end{Definition}
...
\section{Вариограмма случайного процесса}
