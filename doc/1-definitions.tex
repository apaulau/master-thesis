...
\begin{Definition}
    Случайный процесс $ X(t),~ t \in \mathbb{T} $ называется \textit{гауссовским}, если любые $ n $ его отсчетов $ X(t_1), X(t_2), \ldots, X(t_n), $ где $ t_1, t_2, \ldots, t_n \in \mathbb{T} $ имеют n-мерное нормальное распределение, то есть
	\begin{equation}
