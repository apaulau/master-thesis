...
Рассмотрим внутренне стационарный гауссовский случайный процесс с дискретным временем $ X(t),~ t \in \mathbb{Z} $. Не нарушая общности, далее считаем $ m(t) \equiv 0 $, $ V(t) \equiv \sigma^2,~ t \in \mathbb{Z}$.

Вариограмма процесса $ X(t),~ 2 \gamma(h) $, является неизвестной.
