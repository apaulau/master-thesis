...
Случайный процесс $ X(t), t \in \matbb{R} $, называется стационарным в узком смысле, если $ \forall n in \mathbb{N} $, $ \forall t_1, \dots, t_n \in \mathbb{R} $, $ \forall \tau, t_1 + \tau, \dots, t_n + \tau \in \mathbb{R} $
