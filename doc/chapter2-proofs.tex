...
\section{Математическое ожидание оценки вариограммы} % (fold)
...
Таким образом, оценка (\ref{eq:var_estimation}) для вариограммы рассматриваемой модели является \textbf{несмещённой}.

% section variogram_expected (end)

\section{Второй момент оценки вариограммы} % (fold)
...
% section variogram_second_moment (end)

\section{Новый раздел (без названия)} % (fold)
