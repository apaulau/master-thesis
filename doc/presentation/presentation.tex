...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Исследование точности прогноза в зависимости от оценки вариограммы и модели семивариограммы, лежащих в основе метода Кригинг.
  \end{enumerate}
\end{frame}
...
\begin{frame}
  \frametitle{Визуальный подход. \small{График экспериментальной вариограммы}}
  \begin{columns}[c]
  \column{2.5in}
