...
\begin{frame}
  ...
  \begin{equation}
  \label{eq:gamma4}
    \widehat{\gamma}_3(h) = 4 \cdot Lin(h, 2).
  \end{equation}
...
\begin{frame}
  ...
  \begin{equation}
  \label{eq:gamma5}
    \widehat{\gamma}_4(h) = 0.9 + 4 Sph(h, 6.9),
  \end{equation}
...
\begin{frame}
  ...
  \begin{equation}
  \label{eq:gamma6}
    \widehat{\gamma}_5(h) = 4 \cdot Per(h, 0.898),
  \end{equation}
...
\begin{frame}
  \frametitle{\large\secname}
  \framesubtitle{Максимальное расстояние}
  \begin{figure}[H]
...
\begin{frame}
  \frametitle{\large\secname}
  \framesubtitle{Оценки семивариограмм}
  \begin{figure}[h]
...
\begin{frame}
  ...
  \begin{equation}
  \label{eq:gamma10}
    \widehat{\gamma}_7(h) = 3.8 + 0.32 \cdot Per(h, 1.3)
  \end{equation}
