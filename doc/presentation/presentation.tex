...
% \author[Павлов Александр]{\textbf {Павлов Александр Сергеевич} \\ \vspace{3em} \footnotesize Научный руководитель: Цеховая Татьяна Вячеславовна \\ \vspace{1em} \footnotesize Рецензент: Рафеенко Имя Отчество}
