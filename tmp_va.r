...
checkDependency <- function (data, x, y=rep(1, OBS_NUM), width) {
  ...
  i <- 1
  for(l in lens) {
    variogram1 = autofitVariogram(data~1, spdata, cutoff=l, cressie=F, width=width)
    variogram2 = autofitVariogram(data~1, spdata, cutoff=l, cressie=T, width=width)
...
crossPrediction(src$Temperature, src.trend, kriging.classical, "figures/cross_prediction_classical.png")
crossPrediction(src$Temperature, src.trend, kriging.robust, "figures/cross_prediction_robust.png")
